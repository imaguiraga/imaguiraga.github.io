...
var FxSelectorTree = (function () {
    ...
    function FxSelectorTree(placeholder, height, width) {
        ...
        this.vis = d3.select(placeholder).append("svg:svg").attr("width", this.w + this.m[1] + this.m[3]).attr("height", this.h + this.m[0] + this.m[2]).append("svg:g").attr("transform", "translate(" + this.m[3] + "," + this.m[0] + ")");
