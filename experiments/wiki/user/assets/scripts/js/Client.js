...
/*export*/ var ClientBase = (function () {
    ...
    ClientBase.prototype.registerCallback = function (type, callback) {
    ...
    ClientBase.prototype.executeCallbacks = function (type, evt) {
        var callbacks = this._callbacks[type];
    ...
    ClientBase.prototype._onOpen = function (evt) {
        this.executeCallbacks("open", evt);
    };

    ClientBase.prototype._onClose = function (evt) {
        this.executeCallbacks("close", evt);
    };

    ClientBase.prototype._onError = function (evt) {
        this.executeCallbacks("error", evt);
    };

    ClientBase.prototype._onMessage = function (evt) {
        this.executeCallbacks("message", evt);
    };

    ClientBase.prototype._debug = function (str) {
        console.log(str);
    ...
    ClientBase.prototype.send = function (operation, targetId, methodName, data, headers, destination) {
    };
    ClientBase.prototype.sendRaw = function (message) {
    };

    ClientBase.builCommandOperation = function (operation, targetId, methodName, data) {
        var content = data;
    	var body = {
            "operation": operation,
            "targetId": targetId,
    ...
    ClientBase.builCommandMessage = function (operation, targetId, methodName, data, headers, destination) {
...
/*export*/ var WebSocketClient = (function (_super) {
    ...
    WebSocketClient.prototype.send = function (operation, targetId, methodName, data, headers, destination) {
        if (data != null) {
            data = data.trim();
...
/*export*/ var AjaxClient = (function (_super) {
    __extends(AjaxClient, _super);
    function AjaxClient(url) {
        _super.call(this, url);
        this._url = url;
        var _this = this;
    }
    AjaxClient.prototype.send = function (operation, targetId, methodName, data, headers, destination) {
        var _this = this;
...
/*export*/ var Main = (function () {
    ...
    Main.createWebSocketClient = function () {
    ...
    Main.createAjaxClient = function () {
        var hostname = window.location.hostname;
        var destination = null;
    ...
    Main.initTerminal = function (client) {
        //var terminal = null;
        var shellinput = [];
